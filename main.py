...
def main():
   ...
   def add_user()->None:
      ...
      entry_imie.focus()  #to wygodne jest trzeba dodac
   ...
   def edit_user()->None:
      i = listbox_lista_obiektow.index(ACTIVE) # pobieram numerek aktywnego obiektu
      entry_imie.insert(0,users[i].imie) # wprowadzam i tego użytkownika  listy i wprowadzam insertem do pla entry imie
...
#ramka szczegóły obiektu - zawartosc
